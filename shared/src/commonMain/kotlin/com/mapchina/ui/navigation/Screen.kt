...
@Serializable data class CarvingScreen(val regionId: String, val regionName: String, val attractionId: String? = null, val attractionName: String? = null, val carvingId: String? = null) : Screen()
@Serializable data class CarvingListScreen(val regionId: String? = null, val regionName: String? = null, val attractionId: String? = null, val showAll: String? = null) : Screen()
